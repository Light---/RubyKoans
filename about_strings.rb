...
EOS
  ...
  def test_the_shovel_operator_modifies_the_original_string
    ...
    # Answer: 1) No other language does it that way & 2) Messes with the string if used other places
  end
  ...
  def test_you_can_get_a_single_character_from_a_string
    ...
    # Surprised?
    # Answer: No cause Strings start counting from 0...apartently in other languages you can't access what's in a String by [].
  end
